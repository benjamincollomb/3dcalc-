...
/* ============================================================
   TIMBRAGE — Suivi des heures de travail
   Collection Firestore : "timbrages"
   Modèle : { id, dateDebut (ISO), dateFin (ISO|null), month, dureeMin }
   Le compteur repart à 0 automatiquement chaque mois (filtrage par month)
   ============================================================ */
